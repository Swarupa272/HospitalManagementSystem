...
function UserBookAppointment() {
  ...
  useEffect(() => {
    ...
    const fetchDoctors = async (e) => {
      const res = await axios.get("http://localhost:3000/doctor/get-doctors");
      setDoctors(res.data);
    };
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await axios
      .post('http://localhost:3000/appointment/add-appointment', {
  ...
  return (
    <section className="bg-slate-300 flex justify-center items-center">
      ...
      <UserSidebar userName={userData.userName} />
